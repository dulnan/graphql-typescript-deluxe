...
describe('makeComment', () => {
  ...
  it('should handle strings with multiple consecutive comment close delimiters', () => {
    ...
    const result = makeComment(input)
    expect(result).toBe('/** Multiple *\\/*\\/*\\/*\\/ consecutive */')
  })
})
